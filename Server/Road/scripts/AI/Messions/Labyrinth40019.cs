...
{
    public class Labyrinth40019 : AMissionControl
    {
        private List<SimpleNpc> someNpc = new List<SimpleNpc>();

        private int kill = 0;

        private int npcIDs =  40025;

        private int[] birthX = { 1505, 1495, 1485, 1475, 1465, 1455, 1445, 1435, 1415, 1385 };
        ...
        public override void OnStartGame()
        {
            ...
            {
                someNpc.Add(Game.CreateNpc(npcIDs, birthX[i], 337, 1, -1));
            }
