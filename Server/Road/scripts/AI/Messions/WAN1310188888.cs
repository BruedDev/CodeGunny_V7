...
{
    public class WAN1310188888 : AMissionControl
    {	
		//private SimpleBoss boss2 = null;		
		//private SimpleBoss boss = null;
        private List<SimpleBoss> someBoss = new List<SimpleBoss>();

        private int bossID = 1310188888;

        private int bossID2 = 1310288888;
        ...
        public override void OnStartGame()
        {
            ...
            SimpleBoss boss = Game.CreateBoss(bossID2, 1269, 180, -1, 1, "");
            boss.SetRelateDemagemRect(boss.NpcInfo.X, boss.NpcInfo.Y, boss.NpcInfo.Width, boss.NpcInfo.Height);
            someBoss.Add(boss);
            boss = Game.CreateBoss(bossID, 500, 180, -1, 1, "");
            boss.SetRelateDemagemRect(boss.NpcInfo.X, boss.NpcInfo.Y, boss.NpcInfo.Width, boss.NpcInfo.Height);
            someBoss.Add(boss);
