...
{
    public class Labyrinth40003 : AMissionControl
    {
        private List<SimpleNpc> someNpc = new List<SimpleNpc>();
        private int kill = 0;

        private int npcIDs =  40003;

        private int[] birthX = { 1410, 1390, 1360, 1340, 1320, 1300, 1280, 1260, 1240, 1220 };
        ...
        public override void OnStartGame()
        {
            ...
            {
                someNpc.Add(Game.CreateNpc(npcIDs, birthX[i], 450, 1, -1));
            }  
        }
