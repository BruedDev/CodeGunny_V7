...
{
    public class rodbot2 : AMissionControl
    {
        private SimpleBoss boss = null;

        private int npcID = 25002;

        private int bossID = 80002;
        ...
        public override void OnStartGame()
        {
            ...
            boss.Say(LanguageMgr.GetTranslation("欢迎大家来到疯狂世界杯第二关，此副本由星辰制作，大家玩得开心一点喔！"), 0, 200, 0);           
