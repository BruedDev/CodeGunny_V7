...
{
    public class Labyrinth40011 : AMissionControl
    {
        private List<SimpleNpc> someNpc = new List<SimpleNpc>();

        private int kill = 0;

        private int npcIDs = 40014;

        private int[] birthX = { 1330, 1310, 1290, 1270, 1250, 1230, 1210, 1190, 1170, 1150 };
        ...
        public override void OnStartGame()
        {
            ...
            {
                someNpc.Add(Game.CreateNpc(npcIDs, birthX[i], 695, 1, -1));
            }
