...
{
    public class WAN13104123 : AMissionControl
    {
        private List<SimpleBoss> someBoss = new List<SimpleBoss>();

        private int bossID = 13108123;

        private int bossID2 = 13109123;
		
		private int npcID = 13112123;
        ...
        public override void OnPrepareNewSession()
        {
            ...
            Game.AddLoadingFile(2, "image/game/thing/BossBornBgAsset.swf", "game.asset.shuangwangAsset");
            Game.SetMap(1217);
        }
        ...
        public override void OnStartGame()
        {
            ...
            m_front = Game.Createlayer(1000, 600, "font", "game.asset.living.shuangwangAsset", "out", 1, 1);
