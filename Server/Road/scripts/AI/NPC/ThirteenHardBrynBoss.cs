...
namespace GameServerScript.AI.NPC
{
    public class ThirteenHardBrynBoss : ABrain
    {
        ...
        private static string[] AllAttackChat = new string[] {
            LanguageMgr.GetTranslation("來吧..."),

            LanguageMgr.GetTranslation("部落領主的力量！"),

            LanguageMgr.GetTranslation("痛死你！")
        };

        private static string[] ShootChat = new string[]{
            LanguageMgr.GetTranslation("這個石像跟我很像了吧！"),

            LanguageMgr.GetTranslation("武器部落神！")  
        };
        ...
        private static string[] CallChat = new string[]{
            LanguageMgr.GetTranslation("圖騰 ..."),

            LanguageMgr.GetTranslation("你是想找死麼？")
