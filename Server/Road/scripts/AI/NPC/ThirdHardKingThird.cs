    ...
    public class ThirdHardKingThird : ABrain
    {
		...
		private void PersonalAttackDame()
        {
            ...
            if (target != null)
            {
				...
				if (Body.ShootPoint(target2.X, target2.Y, 55, 1000, 10000, 1, 1.5f, 4550))
                {
                    Body.PlayMovie("beatB", 3700, 0);
                }
		...
		private void NextAttack()
        {
            ...
            if (target != null)
            {
				...
				if (Body.ShootPoint(target2.X, target2.Y, 54, 1000, 10000, 1, 1.5f, 4550))
                {
                    Body.PlayMovie("beatA", 3700, 0);
                }
            }
        }
