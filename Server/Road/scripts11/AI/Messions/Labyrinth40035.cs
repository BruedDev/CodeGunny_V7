...
namespace GameServerScript.AI.Messions
{
    public class Labyrinth40035 : AMissionControl
    {
        ...
        private int[] birthX = { 1110, 1090, 1060, 1040, 1020, 1000, 980, 960, 940, 920 };
        ...
        public override void OnStartGame()
        {
            ...
            for (int i = 0; i < birthX.Length; i++)
            {
                if (birthX[i] > 1000)
                {
                    someNpc.Add(Game.CreateNpc(npcIDs, birthX[i], 534, 1, -1));
                }
                else
                {
                    someNpc.Add(Game.CreateNpc(npcIDs2, birthX[i], 534, 1, -1));
                }
            }
