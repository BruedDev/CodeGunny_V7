...
namespace GameServerScript.AI.Messions
{
    public class RRCN7102 : AMissionControl
    {
        ...
        public override void OnStartGame()
        {
            base.OnStartGame();
            Game.IsBossWar = "7102";
            someBoss.Add(Game.CreateBoss(bossID, 1565, 787, -1, 1, "standA"));
            someBoss.Add(Game.CreateBoss(bossID, 1583, 495, -1, 1, "standA"));
            someBoss.Add(Game.CreateBoss(bossID, 1643, 236, -1, 1, "standA"));
        }
