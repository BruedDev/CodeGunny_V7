...
{
    public class Labyrinth40027 : AMissionControl
    {
        private List<SimpleNpc> someNpc = new List<SimpleNpc>();

        private int kill = 0;

        private int npcIDs = 40035;

        private int[] birthX = { 1510, 1460, 1420, 1380, 1340};
        ...
        public override void OnStartGame()
        {
            ...
            {
                someNpc.Add(Game.CreateNpc(npcIDs, birthX[i], 620, 1, -1));
            }
