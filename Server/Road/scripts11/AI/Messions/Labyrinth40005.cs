...
{
    public class Labyrinth40005 : AMissionControl
    {
        private List<SimpleNpc> someNpc = new List<SimpleNpc>();
        private int kill = 0;

        private int npcIDs =  40005;

        private int[] birthX = { 830, 810, 790, 770, 750, 730, 710, 690, 670, 650 };
        ...
        public override void OnStartGame()
        {
            ...
            {
                someNpc.Add(Game.CreateNpc(npcIDs, birthX[i], 645, 1, -1));
            }
