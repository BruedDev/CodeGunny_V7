...
{
    public class DLH5202 : AMissionControl
    {
        ...
        private int bossID2 = 5213;

        private int bossID3 = 5212;

        private int npcID = 5216;

        private int npcID2 = 5217;

        private int npcID3 = 5211;
        ...
        public override void OnNewTurnStarted()
        {
            ...
            if (boss != null && boss.IsLiving == false && king != null && king.IsLiving == false)
            {
