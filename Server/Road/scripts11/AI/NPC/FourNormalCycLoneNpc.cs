...
namespace GameServerScript.AI.NPC
{
    public class FourNormalCycLoneNpc : ABrain
    {
		...
		public void BestC()
        {
			...
			Body.RangeAttacking(dis, dis, "cry", 4000, null);
		...
		public void CreateChild()
        {
            ...
            ((SimpleBoss)Body).CreateChild(npcID, dis, 700, 400, 2, -1);
        }
		
		public void CreateChild2()
        {
            int dis = Game.Random.Next(340, 340);
            ((SimpleBoss)Body).CreateChild(npcID2, dis, 700, 400, 1, 1);
        }
