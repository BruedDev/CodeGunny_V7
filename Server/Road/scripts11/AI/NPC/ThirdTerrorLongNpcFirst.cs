...
namespace GameServerScript.AI.NPC
{
    public class ThirdTerrorLongNpcFirst : ABrain
    {
        ...
        private static string[] KillAttackChat = new string[]{
             LanguageMgr.GetTranslation("Đến gần ta, chỉ có chết!!"),
			 
			 LanguageMgr.GetTranslation("Tiêu diệt họ sẻ có thưởng!!")
        };
        ...
        {
            int dis = Game.Random.Next(-50, 50);
            Body.MoveTo(Body.X + dis, Body.Y, "walk", 1000, "", 3, new LivingCallBack(NextAttack));
        }
        ...
        private void NextAttack()
        {
            ...
            if (target != null)
            {
                ...
                if (Body.ShootPoint(target.X, target.Y, 58, 1000, 10000, 3, 2.5f, 2550))
                {
            ...
            if (sayCount > 0)
            {
                ...
                for (int i = 0; i < sayCount;)
                {
                    ...
                    if (livings[index].IsSay == false)
                    {
                        ...
                        livings[index].Say(ThirdTerrorLongNpcFirst.GetOneChat(), 0, delay);
                        i++;
                    }
                }
            }
