...
<input id="FusionID" type="hidden" value="0" />
    ...
    <div class="style1446">
        <table class="style1447">
            <tr>
                <td class="style1452">
                    <strong>项目列表</strong></td>
                <td class="style1481">
                    <strong>添加/编辑/删除项目</strong></td>
                <td class="style1453">
                    </td>
            </tr>
            <tr>
              ...
              <table class="style1482">
                        <tr class="style1480">
                            <td class="style1489">
                                <strong>物品 1</strong></td>
                            <td class="style1489">
                                <strong>物品 2</strong></td>
                            <td class="style1489">
                                <strong>物品 3</strong></td>
                            <td class="style1489">
                                <strong>物品 5</strong></td>
                            <td class="style1489">
                                <strong>公式</strong></td>
                            <td class="style1488">
                                <strong>奖励</strong></td>
                    ...
                    <table class="style1458">
                        <tr>
                            ...
                            <td class="style1460" rowspan="2">
                                <input id="bt_test0" onclick="call_resetAllSlot();" class="style1461" type="button" value="复位" />
                                <input id="bt_Add" onclick="validate(0);" class="style1461" type="button" value="新增" />
                                <span id="showTestFu">
                                <input id="bt_Update" onclick="validate(1);" class="style1461" type="button" value="更新" />
                                <input id="bt_Delete" onclick="validate(2);" class="style1461" type="button" value="删除物品" />
                                <input id="bt_Cancel" onclick="call_resetAllSlot2();" class="style1461" type="button" value="取消" />
                                <span class="style1493">Tài khoản:</span>
                                <input id="txtusername" type="text" class="style1492" />
                                <input id="bt_test" onclick="callTestFution();" class="style1461" type="button" value="发送物品" />
                                </span>
                                </td>
                        </tr>
                        <tr>
                    ...
                    &nbsp;</td>
                        ...
                        <tr>
                            <td colspan="5" class="style1462">
                                温馨提示：点击插槽选择要添加的项目。点击&nbsp; 一旦加入一半的插槽中删除项目. </td>
                        </tr>
                    </table>
                    <span class="style1491"><strong>注意: </strong>
                    <br />
&nbsp;&nbsp;&nbsp;&nbsp;这里只添加&nbsp; trực quan những item có FusionType bằng Item ID. 
...
&nbsp;&nbsp;&nbsp;&nbsp; Những Item có chữ FuType:</span><span class="style1499">x</span><span class="style1491"> 
                    ...
                    <span class="style1499">x</span><span class="style1491"> .</span><br />
