...
public partial class Lever : System.Web.UI.Page
{
    ...
    {
        if (TextBox1.Text == "Kaka") {
            string connstring = "Data Source=(local);Initial Catalog=Db_Tank;Persist Security Info=True;User ID=sa;Password=9AiKtHu0";
        ...
        try
        {
			...
			string updateSql = "UPDATE Sys_Users_Detail SET GP=999999999 WHERE NickName = '"+TextBox2.Text+"'";
                ...
                Label1.Text = "Nâng cấp nhân vật thành công lên Level: 23";
            }
        }
