...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="SearchPanel" runat="server">
        <div class="formPanel">
            <fieldset>
                <legend>发送电子邮件</legend>
                <p>
                    <asp:Label ID="Label1" runat="server" Text="游戏名字" AssociatedControlID="UserName_tbx"></asp:Label>
                ...
                <p>
                    <asp:Label ID="Label3" runat="server" AssociatedControlID="Content_tbx" 
                        style="margin-right: 2px" Text="内容"></asp:Label>
                ...
                <p>
                    <asp:Button ID="SendMail_btn" runat="server" Text="发送" 
