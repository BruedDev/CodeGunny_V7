    ...
    <asp:Panel ID="accountPanel" runat="server">
        <fieldset>
            ...
            <p>
                <asp:FormView ID="FormView1" runat="server" DataSourceID="ObjectDataSource1">
                    <EditItemTemplate>
                        ...
                        &nbsp;<asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False"
                            CommandName="Cancel" Text="Hủy bò" />
                    </EditItemTemplate>
                    <InsertItemTemplate>
                        ID:
                ...
                <asp:Label ID="error_lbl" runat="server" Text="标签" CssClass="failureNotification"></asp:Label>
                 <p>
         ...
         <asp:Button ID="Button1" runat="server" Text="向后" onclick="Button1_Click" />
    </asp:Panel>
</asp:Content>
