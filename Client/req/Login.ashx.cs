    ...
    public class Login : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            XElement result = new XElement("Result");
                //login.ashx?site=&
                //selfid=NaN&
                //key=a7ffd126c4ddee3b340e8e27700a5ac1&
                //rid=&
                //p=JuOVsPUwpLpt5%2BE%2FcqUjRNSfFGwAMYkI74Fh83Xf1X70fiFUVj1y9yQKTriIkcRWg9z8LM2g5GhBPkdXmdE7zCebWbGf54jX30L2%2F8Sdq%2BLBLApYyqbZ4PLFcJUGDsS%2FV%2Ft9Vq6pfC2dovOO%2FDrDH2LzddTuzXcJn3ps5BrDQCs%3D&
                //v=5498628
            try
            {
                ...
                if (!string.IsNullOrEmpty(p))
                {
                    ...
                    if (strList.Length == 4)
                    {
                        ...
                        if (PlayerManager.Login(name, pwd.ToUpper()))
                        {
                            int isFirst = 0;
                            bool isActive = false;
